...
xChartCallout::xChartCallout(QGraphicsItem * parent):
    QGraphicsItem(parent)
{
}

QRectF xChartCallout::boundingRect() const
{
...
void xChartCallout::paint(QPainter *painter, const QStyleOptionGraphicsItem *option, QWidget *widget)
{
    Q_UNUSED(option)
    Q_UNUSED(widget)
    QPainterPath path;
...
void xChartCallout::mousePressEvent(QGraphicsSceneMouseEvent *event)
{
    event->setAccepted(true);
}

void xChartCallout::mouseMoveEvent(QGraphicsSceneMouseEvent *event)
{
...
void xChartCallout::setText(const QString &text)
{
    m_text = text;
...
void xChartCallout::setAnchor(QPointF point)
{
    m_anchor = point;
}
